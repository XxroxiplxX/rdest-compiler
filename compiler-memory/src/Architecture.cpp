...
std::shared_ptr<Register> &Memory::get_variable(std::string &identificator) {
  return variables[identificator];
}
std::vector<std::string> &Memory::get_argument_identificators() {
  return argument_identificators;
}
std::shared_ptr<Register> &Memory::get_return_adress() { return return_adress; }
...
std::shared_ptr<Register> &Architecture::get_constant(std::string &number) {
