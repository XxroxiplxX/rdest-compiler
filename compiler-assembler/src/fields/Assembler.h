...
public:
  ...
  virtual void
  set_address(std::shared_ptr<VirtualMachineModel::Register>& _register) {}
...
class AsmBasicInstruction : public AsmNotJumpInstruction {
  std::shared_ptr<VirtualMachineModel::Register> address;

public:
void print(std::ostream &os) override;
  void
  set_address(std::shared_ptr<VirtualMachineModel::Register>& _register) override;
};
